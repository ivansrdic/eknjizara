	...
	<main class = "container margin2000">
		...
		<div class = "row margin0020">
			<div class = "one-third column">
				<h5>Ukupno</h5>
				<h5 class = "no-margin">Sve</h5>
			</div>
			<div class = "one-third column">
				<h5>Od knjižare</h5>
				<h5 class = "no-margin">0</h5>
			</div>
			<div class = "one-third column">
				<h5>Od klijenata</h5>
				<h5 class = "no-margin">Sve</h5>
		...
		<div class = "admin border-top"> <!-- DISPLAY ONLY IF ADMIN PROFILE -->
			...
			<div class = "row margin2020">
				<div class = "one-third column">
					<a href="{{ URL::route('add-book') }}" class = "center"><h5>Dodavanje nove knjige</h5></a>
				</div>
				<div class = "one-third column">
					<a href="{{ URL::route('admin-book-list') }}" class = "center"><h5>Pregled dostupnih knjiga</h5></a>
				</div>
				<div class = "one-third column">
					<a href="{{ URL::route('admin-registered-list')}}" class = "center"><h5>Popis registriranih klijenata</h5></a>
				</div>
			</div>
		</div>
